...
import tableau.api.rest.bindings.GroupType;
...
public class RestApiUtils {
    ...
    public TsResponse invokeUpdateUser(TableauCredentialsType credential, UserType userType, String fullName, String email, String password, SiteRoleType siteRole) {
    ...
    private TsRequest createPayloadForUpdateUser(String fullName, String email, String password, SiteRoleType siteRole) {
        TsRequest requestPayload = m_objectFactory.createTsRequest();
    ...
    public void invokeDeletePermissionsToWorkbook(TableauCredentialsType credential, String workbookId, String userId, String capabilityName, String capabilityMode){
    ...
    public void delete(String url, String authToken) {
        Client client = Client.create();
        WebResource webResource = client.resource(url);
